...
# 입력: 파싱된 주문 행 리스트
orders = [
    {"store_code": "GN", "store_name": "강남점", "bean_code": "ETH-YRG",
...
```text
사용자: "강남점 Sheets URL 바꿔줘" (브라우저에서 해당 시트를 열어둔 상태)
에이전트: "현재 열린 Sheets URL을 강남점으로 등록할까요? [URL 표시]"
사용자: "응"
에이전트: "✅ 강남점 URL 업데이트 완료."
```
...
- 예시: "강남점, 홍대점까지 처리 완료. 성수점 접근 실패. '성수점부터 다시 해줘'라고 말씀하세요."
